...
loterry = soup.find_all("button", {"class": "btn-primary"})
loterry_list = []
for i in loterry:
    loterry_list.append(i.text)
print(loterry_list)
...
reward = tk.Label(root, text=loterry_list[0], font=("Arial", 20))
...
reward = tk.Label(root, text=loterry_list[1], font=("Arial", 20))
...
reward = tk.Label(root, text=loterry_list[2], font=("Arial", 20))
reward.grid(row=2, column=1, padx=10, pady=10)
reward = tk.Label(root, text=loterry_list[3], font=("Arial", 20))
...
reward = tk.Label(root, text=loterry_list[4], font=("Arial", 20))
reward.grid(row=3, column=1, padx=10, pady=10)
reward = tk.Label(root, text=loterry_list[5], font=("Arial", 20))
